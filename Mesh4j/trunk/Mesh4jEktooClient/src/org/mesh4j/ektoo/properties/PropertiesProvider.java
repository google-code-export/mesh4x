...
public class PropertiesProvider {
	...
	public void setDefaults(Modem modem, String defaultPhoneNumber,
			String defaultDataSource, String defaultTableName, String defaultURL) {
		...
		if (modem != null && modem.getBaudRate() > 0) {
			this.properties.put("default.sms.baud.rate", String.valueOf(modem
					.getBaudRate()));
		}
	...
	public IMessageEncoding getDefaultMessageEncoding() {
		return (IMessageEncoding) getInstance("default.sms.compress.method",
				NonMessageEncoding.INSTANCE);
	}
	...
	public int getItemEncodingBlockSize() {
		return Integer.valueOf(this.properties.getProperty(
				"default.sms.item.encoding.block.size", "100"));
	}
