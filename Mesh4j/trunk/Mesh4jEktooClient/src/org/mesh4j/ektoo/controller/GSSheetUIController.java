 ...
 *
 */
public class GSSheetUIController extends AbstractController implements IUIController
{
  ...
  {
    setModelProperty( LASTUPDATE_COLUMN_POSITION_PROPERTY, lastUpdatedColumnPosition);
  }
