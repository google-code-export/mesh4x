...
public class ImageManager 
{
  ...
  {
    return SwingResourceManager.getImage(EktooFrame.class, "/instedd_small.png");
  }
  ...
  {
    return SwingResourceManager.getIcon(EktooFrame.class, "/dataSourceSmall.png");
  }
  
  public static Icon getDatabaseConnectionIcon() 
  {
    return SwingResourceManager.getIcon(EktooFrame.class, "/connection_16.png");
  }
  ...
  public static Icon getSourceImage(String source, boolean remote)
  {
    ...
    {
      return SwingResourceManager.getIcon(EktooFrame.class, "/cloud_ds.png");      
    } 
    else if (source.startsWith(SyncItemUI.KML_PANEL))
    {
      return SwingResourceManager.getIcon(EktooFrame.class, "/kml_ds.png");
    } 
    else if (source.startsWith(SyncItemUI.MS_ACCESS_PANEL))
    {
      return SwingResourceManager.getIcon(EktooFrame.class, "/access_ds.png");
    } 
    else if (source.startsWith(SyncItemUI.MS_EXCEL_PANEL))
    {
      return SwingResourceManager.getIcon(EktooFrame.class, "/excel_ds.png");
    }
    else if (source.startsWith(SyncItemUI.MYSQL_PANEL))
    {
      return SwingResourceManager.getIcon(EktooFrame.class, "/mysql_ds.png");
    } 
    ...
    {
      return SwingResourceManager.getIcon(EktooFrame.class, "/rss_ds.png");
    } 
    else if (source.startsWith(SyncItemUI.ATOM_FILE_PANEL))
    {
      return SwingResourceManager.getIcon(EktooFrame.class, "/atom_ds.png");
    } 
    else 
    {
      return SwingResourceManager.getIcon(EktooFrame.class, "/ds.png");
  ...
  {
    return SwingResourceManager.getIcon(EktooFrame.class, "/inProgress.gif");
  }
  ...
  public static Icon getStatusProcessingIcon() {
    return SwingResourceManager.getIcon(EktooFrame.class, "/processing.png");
  }
  ...
  public static Icon getCloudErrorIcon() {
    return SwingResourceManager.getIcon(EktooFrame.class, "/cloudError.jpg");
  }
  ...
  {
    return SwingResourceManager.getIcon(EktooFrame.class, "/16x16/error.png");
  }

  public static Icon getWarningIcon()
  {
    return SwingResourceManager.getIcon(EktooFrame.class, "/16x16/warning.png");
  }

  public static Icon getInfoIcon()
  {
    return SwingResourceManager.getIcon(EktooFrame.class, "/16x16/info.png");
  }

  public static Icon getSuccessIcon()
  {
    return SwingResourceManager.getIcon(EktooFrame.class, "/16x16/accept.png");
  }
  ...
  {
    return SwingResourceManager.getIcon(EktooFrame.class, "/16x16/progress.gif");
  }
