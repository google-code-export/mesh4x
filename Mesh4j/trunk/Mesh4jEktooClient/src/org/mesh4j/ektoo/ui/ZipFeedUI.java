...
public class ZipFeedUI extends AbstractUI  implements IValidationStatus {

	private static final long serialVersionUID = 2457237653577593698L;

	private static final Log LOGGER = LogFactory.getLog(ZipFeedUI.class);
	...
	public boolean verify() {
		boolean valid = (new ZipFeedUIValidator(this, controller.getModel(), null)).verify();
		return valid;
	}
