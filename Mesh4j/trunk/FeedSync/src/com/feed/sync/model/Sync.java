...
public class Sync implements Cloneable{
	...
	public void removeConflict(Item item) {
		this.conflicts.remove(item);		
	}

	public void markWithoutConflicts() {
		this.noConflicts = true;
	}

	public void markWithConflicts() {
	...
	public boolean equals(Object obj){
		...
		if (obj != null)
		{
			if(obj instanceof Sync){
				...
				return this.getId() == otherSync.getId() &&
	...
	public Sync clone(){
		...
		// TODO (?): newSync.itemHash = this.itemHash;
