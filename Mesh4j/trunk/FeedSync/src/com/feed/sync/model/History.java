...
public class History implements Cloneable {
	...
	public History(String by, Date when, int sequence) {
		...
		if ((by == null || by.length() == 0) && when == null)
			throw new IllegalArgumentException("Arg_EitherWhenOrByMustBeSpecified");   // TODO resource bundle
		if (sequence <= 0)
			throw new IllegalArgumentException("Arg_SequenceMustBeGreaterThanZero");
