...
public class KMLExporterTests {
	...
	public void shouldCreatePlacemark(){
		...
		Assert.assertEquals("<Placemark><name>Patient: Juan</name><description><![CDATA[Adress: Buenos Aires]]></description><Point><coordinates>-58.373,-34.608</coordinates></Point></Placemark>", placemark);
	}
