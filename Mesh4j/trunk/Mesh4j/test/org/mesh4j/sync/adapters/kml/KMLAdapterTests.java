...
public class KMLAdapterTests {
	...
	public void shoulRefreshContent() throws DocumentException, JaxenException {
		...
		String localXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
				...
				+ "	</LabelStyle>"
				+ "</Style>"
				+ "<Style xmlns:mesh4x=\"http://mesh4x.org\" id=\"sn_ylw-pushpin_6\" xml:id=\"6\"  mesh4x:originalId=\"sh_ylw-pushpin\" >"
				+ "	<IconStyle>"
				+ "		<color>ff00ff55</color>"
				+ "		<scale>1.1</scale>"
				+ "		<Icon>"
	...
	public void shouldAdd() throws DocumentException {
		...
		localXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
			+ "<kml xmlns=\"http://earth.google.com/kml/2.2\">"
			+ "<Document>"
			+ "<mesh4x:hierarchy xmlns:mesh4x=\"http://mesh4x.org\" xml:id=\""+ hierarchySyncID +"\" mesh4x:parentId=\"1\" mesh4x:childId=\""+syncID+"\" />"
			+ "</Document>" + "</kml>";
