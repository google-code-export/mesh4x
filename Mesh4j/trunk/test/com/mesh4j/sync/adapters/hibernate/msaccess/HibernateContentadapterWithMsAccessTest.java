package com.mesh4j.sync.adapters.hibernate.msaccess;
...
import com.mesh4j.sync.adapters.hibernate.HibernateContentAdapter;
...
public class HibernateContentadapterWithMsAccessTest {
	...
	private void addHibernateProperties() {
		System.setProperty("hibernate.dialect","com.mesh4j.sync.adapters.hibernate.MSAccessDialect");
