...
public class SmsMessageReceiverTests {
	...
	public void ShouldAddReceivedPayloadWhenReceivingSingleMessageBatch()
	{
		...
		receiver.receiveMessage(batch.getMessage(0));
	...
	public void ShouldAcceptMultiMessageBatchesAndReconstitutePayload()
	{
		...
		receiver.receiveMessage(batch.getMessage(1));
		Assert.assertEquals(0, receiver.getCompletedBatchesCount());
		
		receiver.receiveMessage(batch.getMessage(2));
		Assert.assertEquals(0, receiver.getCompletedBatchesCount());

		receiver.receiveMessage(batch.getMessage(3));
		Assert.assertEquals(1, receiver.getCompletedBatchesCount());
	...
	public void ShouldAcceptMultiMessagesOutOfOrder()
	{
		...
		receiver.receiveMessage(originalbatch.getMessage(1));
		Assert.assertEquals(0, receiver.getCompletedBatchesCount());

		receiver.receiveMessage(originalbatch.getMessage(0));
		Assert.assertEquals(1, receiver.getCompletedBatchesCount());
	...
	@Test
	public void ShouldKnowEhenFirstMessageAndLastMessageOfBatchReceived()
	{
	...
	public void ShouldDiscardMessagesOfDiscardedBatches()
	{
		...
		receiver.receiveMessage(originalbatch.getMessage(4));
	...
	public void ShouldExposeReasonForDiscarded()
	{
		...
		receiver
			.receiveMessage(originalbatch.getMessage(3))
	...
	public void ShouldDiscardMessagesOfCompeltedBatches()
	{
		...
		receiver
			.receiveMessage(originalbatch.getMessage(0))
			.receiveMessage(originalbatch.getMessage(1));
