...
import com.mesh4j.sync.adapters.file.SyncFileRepository;
...
public class KMLSyncEngineTests {
	...
	public void spike() throws DocumentException{
		...
		SyncFileRepository syncFileRepo1 = new SyncFileRepository(syncFile1);
		...
		SyncFileRepository syncFileRepo2 = new SyncFileRepository(syncFile2);
