...
/*
	//my test:convert
	public RDFInstance createNewInstanceFromPlainXML(String id, Element plainXML, Map<String, ISchemaTypeFormat> formatters, Map<String, Resource> syncSchema, Map<String, String> schemaConvertMap) throws ParseException;
	
	//my test:revert
	public RDFInstance createNewInstanceFromRDFXML(Element rdfXml, Map<String, Resource> syncSchema, Map<String, String> schemaRevertMap);
*/
}