...
public class MsExcelRDFSyncAdapterFactoryXLSXTests {
	...
	public void shouldCreateFailsIfRDFUrlIsNull(){
		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), "sheetName", new String[0], null, NullIdentityProvider.INSTANCE, null);
	}

	@Test(expected=IllegalArgumentException.class)
	public void shouldCreateFailsIfRDFUrlIsEmpty(){
		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), "sheetName", new String[0], null, NullIdentityProvider.INSTANCE, "");
	}
	...
	public void shouldCreateAdapterFailsIfSheetNameIsNull(){
		...
		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), null, new String[]{"idColumnName"}, null, NullIdentityProvider.INSTANCE, "http://localhost:8080/mesh4x/myExample");
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void shouldCreateAdapterFailsIfSheetNameIsEmpty(){

		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), "", new String[]{"idColumnName"}, null, NullIdentityProvider.INSTANCE, "http://localhost:8080/mesh4x/myExample");
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void shouldCreateAdapterFailsIfIdColumnIsNull(){

		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), "sheetName", null, null, NullIdentityProvider.INSTANCE, "http://localhost:8080/mesh4x/myExample");
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void shouldCreateAdapterFailsIfIdColumnIsEmpty(){

		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), "sheetName", new String[0], null, NullIdentityProvider.INSTANCE, "http://localhost:8080/mesh4x/myExample");
	}
	
	@Test(expected=IllegalArgumentException.class)
	public void shouldCreateAdapterFailsIfIdentityProviderIsNull(){
		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), "sheetName", new String[0], null, null, "http://localhost:8080/mesh4x/myExample");
	}
	...
	public void shouldCreateAdapterFromRDFFailsIfIdColumnIsNull(){
		RDFSchema rdfSchema = new RDFSchema("Oswego", "http://localhost:8080/mesh4x/myExample/Oswego#", "Oswego");
		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), NullIdentityProvider.INSTANCE, rdfSchema);
	}
	...
	public void shouldCreateAdapterFromRDFFailsIfIdentityProviderIsNull(){
		RDFSchema rdfSchema = new RDFSchema("Oswego", "http://localhost:8080/mesh4x/myExample/Oswego#", "Oswego");
		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), null, rdfSchema);
	}

	@Test(expected=IllegalArgumentException.class)
	public void shouldCreateAdapterFromRDFFailsIfRDFSchemaIsNull(){
		MsExcelRDFSyncAdapterFactory.createSyncAdapter(new MsExcel("excelFileName.xlsx"), NullIdentityProvider.INSTANCE, null);
	}
	...
	public void shouldCreateAdapterFromRDFCreateFile(){
		...
		String newFileName = TestHelper.fileName("MsExcel_RDF_"+IdGenerator.INSTANCE.newID()+".xlsx");
	...
	private String getFileNameToTest() {
		try{
			String originalFileName = this.getClass().getResource("epiinfo.xlsx").getFile();
