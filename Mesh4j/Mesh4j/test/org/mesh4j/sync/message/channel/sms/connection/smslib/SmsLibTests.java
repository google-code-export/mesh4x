...
//		
	...
	public void shouldMeshKMLWithSMSLib() throws InterruptedException{
		...
		IMessageSyncAdapter adapterA = new MessageSyncAdapter(sourceId, "kml", NullIdentityProvider.INSTANCE, kmlAdapterA, null);
		...
		IMessageSyncAdapter adapterB = new MessageSyncAdapter(sourceId, "kml", NullIdentityProvider.INSTANCE, kmlAdapterB, null);
