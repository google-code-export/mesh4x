...
public class MessageRepositoryFactory implements IMessageRepositoryFactory{
	...
	public IMessageRepository createMessageManager(PropertiesProvider prop) {
		String inboundDirectory = prop.getString(IProperties.INBOUND_DIR, prop.getCurrentDirectory()+"\\inbound\\");
		String outboundDirectory = prop.getString(IProperties.OUTBOUND_DIR, prop.getCurrentDirectory()+"\\outbound\\");
