...
public class SmsMessageBatchPendingACKRecordFilter implements RecordFilter {
	...
	public SmsMessageBatchPendingACKRecordFilter(SmsMessageBatchParser parser) {
	...
	public boolean matches(byte[] data) {
		...
		return !batch.isDiscarded() && batch.isComplete() && batch.isWaitingForACK();
	}
}
