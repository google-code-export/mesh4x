...
namespace Mesh4n.Tests.Model
{
	...
	public class ItemFixture : TestFixtureBase
	{
		...
		{
			Item obj1 = new Item(new XmlItem("a", "b", GetElement("<c/>"), DateTime.Now), new Sync(Guid.NewGuid().ToString()));
			Item obj2 = obj1;
		...
		{
			Item obj1 = new Item(new XmlItem("foo", "bar", GetElement("<payload/>"), DateTime.Now), new Sync(Guid.NewGuid().ToString()));
		...
		{
			Item obj1 = new Item(new XmlItem("foo", "bar", GetElement("<payload/>"), DateTime.Now), new Sync(Guid.NewGuid().ToString()));
			Item obj2 = new Item(new XmlItem("foo", "bar", GetElement("<payload id='2'/>"), DateTime.Now), obj1.Sync);
